        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody class="text-sm divide-y divide-slate-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
                        ...
                        <td class="px-5 py-4 whitespace-nowrap text-right text-sm">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('admin.categories.destroy', $category->id_product_category) }}" method="POST" class="inline" onsubmit="return confirm('Anda yakin ingin menghapus kategori ini? Semua produk di dalamnya mungkin tidak memiliki kategori!');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                    <tr><td colspan="4" class="px-5 py-10 text-center text-sm text-slate-500 dark:text-slate-400">Tidak ada kategori produk ditemukan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
